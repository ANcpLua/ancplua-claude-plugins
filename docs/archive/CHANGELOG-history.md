...
Archived entries from [CHANGELOG.md](../../CHANGELOG.md). The main changelog keeps only the most recent `## [Unreleased]` window — everything older lives here.

## [Unreleased] — pre-archive history
