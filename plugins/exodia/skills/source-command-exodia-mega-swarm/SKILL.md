---
name: source-command-exodia-mega-swarm
description: IF codebase audit or release readiness check THEN use this. 6-12 agents scan in parallel.
  Full(12), quick(6), focused(8). Feed findings into fix (auto-inherited).
---

# source-command-exodia-mega-swarm

Use this skill when the user asks to run the migrated Claude slash command `/exodia:mega-swarm`.
...
Migrated from Claude slash command `/exodia:mega-swarm` into a Codex skill. Invoke it as `$source-command-exodia-mega-swarm` and rewrite provider-specific runtime behavior before relying on it for unattended execution.
