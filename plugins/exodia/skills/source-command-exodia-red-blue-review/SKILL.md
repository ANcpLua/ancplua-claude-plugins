---
name: source-command-exodia-red-blue-review
description: IF adversarial security/quality review needed THEN use this. Red team attacks, Blue
  team defends, Red re-attacks. Scored. Release recommendation. For broad audit ->
  mega-swarm.
---

# source-command-exodia-red-blue-review

Use this skill when the user asks to run the migrated Claude slash command `/exodia:red-blue-review`.
...
Task tool: team_name="red-blue-review", name="red-crash-hunter", subagent_type="general-purpose", model="opus"
...
Task tool: team_name="red-blue-review", name="red-reattacker-[module]", subagent_type="general-purpose"
...
> teammate: red-crash-hunter | team: red-blue-review | subagent_type: general-purpose | model: opus
...
> teammate: red-reattacker-[module] | team: red-blue-review | subagent_type: general-purpose | model: opus
...
Migrated from Claude slash command `/exodia:red-blue-review` into a Codex skill. Invoke it as `$source-command-exodia-red-blue-review` and rewrite provider-specific runtime behavior before relying on it for unattended execution.
...
Review unsupported Claude slash-command metadata manually: `allowed-tools`, `effort`.
