...
|---------|--------|---------|----------|
| `/exodia:fix` | 6-12 | Gated pipeline (`severity` P0-P3, `parallelism` standard\|maximum) | Any bug — ad-hoc, P0 (`P0 maximum`), or audit findings (auto-inherited) |
...
4. Fix any issue              → /exodia:fix "issue" (use `/exodia:fix "issue" P0 maximum` for P0; auto-inherits audit findings)
