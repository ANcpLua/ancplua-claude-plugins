---
name: source-command-mutation-minded-testing-mmt
description: "Run the mutation-minded testing workflow \u2014 architecture review, test judgement,\
  \ weak-test rewrite, mutation-resistant branch closure \u2014 on a file, directory,\
  \ or diff."
---

# source-command-mutation-minded-testing-mmt

Use this skill when the user asks to run the migrated Claude slash command `/mutation-minded-testing:mmt`.
...
Migrated from Claude slash command `/mutation-minded-testing:mmt` into a Codex skill. Invoke it as `$source-command-mutation-minded-testing-mmt` and rewrite provider-specific runtime behavior before relying on it for unattended execution.
