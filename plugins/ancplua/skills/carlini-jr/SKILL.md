---
name: carlini-jr
description: "Leaderless multi-agent swarm with Playwright oracle. Spawns N workers in isolated worktrees with pre-partitioned DOD items. Workers implement and verify via screenshots. No orchestrator, no shared state."
