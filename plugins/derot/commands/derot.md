---
description: Truth-drift pass over a repo — find & fix comment/doc/CI/version/dependency rot that contradicts the actual code, with root + transitive verification. Optional scope arg (path or glob). Fans out parallel rot-scouts on large repos.
---
