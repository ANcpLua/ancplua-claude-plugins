---
description: Migrate specific packages to their new APIs — read the canonical upstream source (releases/tags/changelog/API), detect what changed, rewrite this repo's usages, delete obsolete glue, and validate. Every non-trivial finding survives adversarial refutation before it is applied. /derot proposes dependency changes; /depmigrate applies them.
