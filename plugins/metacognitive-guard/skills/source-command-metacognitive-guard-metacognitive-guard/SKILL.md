---
name: source-command-metacognitive-guard-metacognitive-guard
description: Monitors Claude's responses for struggle signals and suggests escalation to deep-thinking
  agents when complexity exceeds comfortable reasoning capacity.
---

# source-command-metacognitive-guard-metacognitive-guard

Use this skill when the user asks to run the migrated Claude slash command `/metacognitive-guard:metacognitive-guard`.
...
Migrated from Claude slash command `/metacognitive-guard:metacognitive-guard` into a Codex skill. Invoke it as `$source-command-metacognitive-guard-metacognitive-guard` and rewrite provider-specific runtime behavior before relying on it for unattended execution.
