---
name: source-command-metacognitive-guard-deep-analysis
description: Structured 4-phase analysis with transparent reasoning and adversarial self-review.
  Use for complex decisions, architecture choices, debugging dead-ends, or any problem
  where jumping straight to implementation would be premature.
---

# source-command-metacognitive-guard-deep-analysis

Use this skill when the user asks to run the migrated Claude slash command `/metacognitive-guard:deep-analysis`.
...
Migrated from Claude slash command `/metacognitive-guard:deep-analysis` into a Codex skill. Invoke it as `$source-command-metacognitive-guard-deep-analysis` and rewrite provider-specific runtime behavior before relying on it for unattended execution.
