...
# C# suppressions
# Exclude: string literals (code templates for source generators), auto-generated markers
CS_SUPPRESS=$(echo "$ADDED_LINES" | grep -iE '#pragma\s+warning\s+disable|SuppressMessage|DisableWarning' | \
    grep -vE '".*#pragma|AppendLine.*pragma|<auto-generated|PragmaDisable|// <auto-generated' || true)
