...
export function buildMeasurementPlan(result) {
  ...
  const toolsets = [
    createToolset({
      ...
      evidenceSources: [
        "Anthropic Messages API usage logs",
    ...
    createToolset({
      ...
      why:
        "For Claude Code plugins and many higher-agency skills, tool correctness is often the real determinant of user value.",
      signals: [
    ...
    createToolset({
      ...
      evidenceSources: [
        ...
        "Anthropic Messages API timestamps combined with usage logs",
      ],
      starterPack: {
