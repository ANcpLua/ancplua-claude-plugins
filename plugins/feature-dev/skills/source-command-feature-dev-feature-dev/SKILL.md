---
name: source-command-feature-dev-feature-dev
description: Guided feature development with codebase understanding and architecture focus
---

# source-command-feature-dev-feature-dev

Use this skill when the user asks to run the migrated Claude slash command `/feature-dev:feature-dev`.
...
Migrated from Claude slash command `/feature-dev:feature-dev` into a Codex skill. Invoke it as `$source-command-feature-dev-feature-dev` and rewrite provider-specific runtime behavior before relying on it for unattended execution.
