---
name: source-command-feature-dev-review
description: Perform a comprehensive code review on specified files or changes
---

# source-command-feature-dev-review

Use this skill when the user asks to run the migrated Claude slash command `/feature-dev:review`.
...
Migrated from Claude slash command `/feature-dev:review` into a Codex skill. Invoke it as `$source-command-feature-dev-review` and rewrite provider-specific runtime behavior before relying on it for unattended execution.

Review unsupported Claude slash-command metadata manually: `effort`, `name`.
