# Project-Memory Quality Criteria

Applies the same six-criterion rubric to `CLAUDE.md`, `AGENTS.md`, `.claude.local.md`, and individual files under `.claude/rules/`. The scoring is identical; only the audience differs (`AGENTS.md` is read by Codex / OpenAI / Codeium tooling, never by Claude Code).
