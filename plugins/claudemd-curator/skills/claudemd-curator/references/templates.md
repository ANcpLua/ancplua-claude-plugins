...
Same templates apply to `CLAUDE.md` and `AGENTS.md`. Each file should be self-contained — Codex / OpenAI tooling reads `AGENTS.md` and never sees `CLAUDE.md`, and vice versa.
