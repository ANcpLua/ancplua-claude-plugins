...
name: otel-expert
description: >-
  Use when working with OpenTelemetry, telemetry, observability, traces, spans, metrics, logs, OTLP,
  semantic conventions, or instrumentation. Triggers on "what attributes should I use",
  "how do I configure the collector", "what's the semconv for X".
